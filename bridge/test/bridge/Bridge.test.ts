...
describe("Cross Chain HTLC Atomic Swap with ERC20", () => {
    ...
    context("EthNet: User -> Contract, BizNet : Contract -> User", async () => {
        ...
        before("Distribute the fund", async () => {
            ...
            console.log("user_eth.address: ", await token_ethnet.balanceOf(user_eth.address));
        });
        ...
        it("Check the balance", async () => {
            ...
            // print all balances
            console.log("old_user_balance_ethnet: ", old_user_balance_ethnet.toString());
            console.log("old_user_balance_biznet: ", old_user_balance_biznet.toString());
            console.log("old_bridge_ethnet_balance: ", old_bridge_ethnet_balance.toString());
            console.log("old_bridge_biznet_balance: ", old_bridge_biznet_balance.toString());
        });
        ...
        it("Create key by User", async () => {
            ...
            // print key and lock box id
            console.log("key: ", key);
            console.log("lock: ", lock);
            console.log("lock_box_id: ", lock_box_id);
        });
